...
YOUR_NAME_HERE = 'joyce'

# Where did you save your Audacity-exported wav file?
#PATH_TO_AUDIO_FILE = r'.mydir/joycefromaudacity.wav'
PATH_TO_AUDIO_FILE = "./joycefromaudacity.wav"
...
START_OFFSET = 9.5 # determined from Audacity recording

# How long it actually took you to say each number, typically 1.5 seconds
SECS_PER_NUMBER = 1.5
SECS_BETWEEN_NUMBERS = 0.5
...
def split_wav(start_offset, secs_between_numbers, secs_per_number):
    ...
    for i, label in enumerate(LABELS):
        label = str(label)
        start_idx = stop_idx + samples_between_numbers
        ...
        outfile = 'recordings_JV' + os.sep + outfile
...
def trim_silence(audio, n_noise_samples=1000, noise_factor=1.0, mean_filter_size=100):
    ...
    # moving average filter with mean_filter_size terms
...
if __name__ == '__main__':
    split_wav(START_OFFSET, SECS_BETWEEN_NUMBERS, SECS_PER_NUMBER)
